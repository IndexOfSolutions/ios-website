    ...
    return (
        <section id='faq' ref={containerRef} className='relative w-full px-4 md:px-8 py-section-vertical-sm md:py-section-vertical'>
            <div className='flex flex-col gap-1 items-center justify-center'>
                ...
                <h2 className='font-[interItalic] text-fg'>Frequently Asked Questions</h2>
            </div>
            <div className='relative container max-w-[1366] mx-auto pt-[60] grid grid-cols-1 gap-16 md:grid-cols-2'>
                <div className="md:sticky md:top-8 flex flex-col gap-4 text-fg h-fit">
                    <h2 className='text-4xl font-[newake] md:text-5xl'>Most Common Questions About Our Services</h2>
                    <p className='font-[inter]'>Lorem ipsum dolor sit amet consectetur. Nulla placerat odio adipiscing eget ut egestas a et sed. Tellus cursus pharetra etiam sodales amet quam. Egestas amet tellus fringilla ac at. Cum ultricies nisl laoreet massa sed faucibus.</p>
                </div>
